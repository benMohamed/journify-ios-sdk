#
#  Be sure to run `pod spec lint Journify.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Journify"
  spec.version      = "0.1.6"
  spec.summary      = "JournifySDK is a Swift library for integrating event tracking and analytics into your iOS application"
  ...
  spec.author             = { "Amine Chouki" => "amine@journify.io" }
  ...
  spec.source       = { :git => "https://github.com/benMohamed/journify-ios-sdk.git", :branch => "CocoaPods" }
